<template>
  <div class="container grey lighten-5">
    <h5 class="blue-grey-text">Pacientes</h5>
    <tabs>
      <template v-slot:lista>
        ...
        <table class="highlight responsive-table card grey lighten-4">
          <thead>
            <tr>
      ...
      <template v-slot:nuevo>
        <div class="row card p-2 grey lighten-4" style="max-width: 650px">
          <h6 class="blue-grey-text">Formulario para paciente nuevo</h6>
